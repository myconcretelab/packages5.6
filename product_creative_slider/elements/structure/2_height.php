	...
	<tr>
		<td>
			<div class="pcs_product_inner">
				<a class="pcs_image_link" href="<?php echo $product_1->pcs_pageLink?>" style="height:<?php echo $slide->imageHeight ?>px; background-image:url(<?php echo  $ih->getThumbnail($product_1->pcs_imageObject,500,$slide->imageHeight,$slide->imageCrop)->src ?>)">
		...
		<td>
			<div class="pcs_product_inner">
				<a class="pcs_image_link" href="<?php echo $product_2->pcs_pageLink?>" style="height:<?php echo $slide->imageHeight ?>px; background-image:url(<?php echo  $ih->getThumbnail($product_2->pcs_imageObject,500,$slide->imageHeight,$slide->imageCrop)->src ?>)">
				<?php if ($slide->productImageInfo) :
						// Here whe are loading the file to fix on image
						Loader::element('image_infos/' . $slide->productImageInfo, array(
