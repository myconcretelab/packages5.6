...
class DashboardThemeSueOptionsController extends DashboardBaseController {
	...
	function view() {
		//$this->set('post', $_POST);
		if ($this->c->cPath == '/dashboard/theme_sue_options') $this->redirect('/dashboard/theme_sue_options/theme_options');

		$this->set('poh', $this->poh);
		Loader::helper('options_generator', 'theme_sue');
		...
		if (is_array($js_files)) :
			foreach ($js_files as $js) :
				$this->addHeaderItem($html->javascript($js, 'theme_sue'));
			endforeach;
		endif;
