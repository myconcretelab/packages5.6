...
<form action="<?php  echo $this->action('edit_preset')?>" method="post">
    <?php  echo Loader::helper('concrete/dashboard')->getDashboardPaneHeaderWrapper(t('Manage Options presets'), false, 'span10', false) ?>
    <div class="ccm-pane-body">
        <table  class="entry-form zebra-striped" width='100%'>
    ...
    <?php  foreach ($list as $k=>$p) :
        ...
        ?>
            <tr <?php  if ($p['pID'] == $poh->get_default_pID()) : ?> style="background:#DDF4FB"<?php  endif ?>>
                ...
                <td align='center'>
                    <?php  if ($p['pID'] == 1 || $p['pID'] == 2 || $p['pID'] == 3):?>
...
<form action="<?php  echo $this->action('save_preset')?>" method='post'>
    <?php  echo Loader::helper('concrete/dashboard')->getDashboardPaneHeaderWrapper(t('Add a new Options presets'), false, 'span10', false) ?>
    <div class="ccm-pane-body">
