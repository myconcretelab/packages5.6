...
<table class="icooon-table icooon">
	<tr>
		...
		<td>
			<h3 style="color:<?php echo $mainColor?>"><?php echo htmlentities($titleText) ?></h3>			
			<p><?php echo $contentText ?></p>
		</td>
		<?php if (isset($linkTo)) : ?>
		<td style="text-align:right">
			<a href="<?php echo $linkTo ?>" class="button button-flat-primary"><?php echo $textLink ?> <i class="icon-arrow-right"></i></a>			
		</td>
		<?php endif ?>
	</tr>
