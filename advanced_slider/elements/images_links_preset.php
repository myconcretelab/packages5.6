...
<table width="100%" class='ccm-roundabout-link-table'>
  <tr>
    ...
    <th width="40%">Animation Preset <small>(optional)</small></th>
  ...
  <tr>
    ...
    <td>
        <select name="imagePID[]" class="presets" title="<?php      print $pID[array_search($file['fID'],$fileLink)] ?>" ><option value="0">Loading...</option></select>
    </td>
