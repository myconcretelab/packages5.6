...
new ContentFlowAddOn ('DEFAULT', {
	...
	ContentFlowConf: {
        ...
        flowSpeedFactor: .5,           // how fast should it scroll?
        flowDragFriction: .5,          // how hard should it be be drag the floe (0 := no dragging)
        scrollWheelSpeed: 0.5,          // how fast should the mouse wheel scroll. nagive values will revers the scroll direction (0:= deactivate mouse wheel)
