...
class MylabEasyAccordionBlockController extends BlockController {
	
	var $pobj;
	
	protected $btTable = 'btMylabEasyAccordion';
	...
	public function getBlockTypeDescription() {
		return t("Transform easily your C5 layouts into collapsible Content");
	}
	...
	return array(
		...
		'tName-required' => t('Oops, your are too little number of row.. Please add rows at your layout'),
	);
	}
	...
	function save ($data) {
		...
		$data['disabled']= is_array($data['disabled']) ? implode(',',$data['disabled']): '99999';
		parent::save($data);
