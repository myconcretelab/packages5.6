    ...
    RESPONSIVEUI.responsiveTabs = function () {
        ...
        if (!$tabSets.hasClass("responsive-tabs--enabled")) {
            ...
            $tabSets.each(function () {
                ...
                // Icic devrait se trouver $tabs.find(".responsive-tabs__panel").not(".responsive-tabs__panel--active").hide().attr("aria-hidden", "true");
                ...
                $tabs.find(".responsive-tabs__heading").each(function () {
					...
					//  remis ici, après le click, pour garder la hauteur
