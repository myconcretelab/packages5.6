...
$form = Loader::helper('form');?>
	...
	<form method="get" id="ccm-core-commerce-product-advanced-search" action="<?php echo $uh->getToolsURL('search_results','mylab_product_attribute')?>">
...
<script>
	$('#ccm-core-commerce-product-advanced-search').ajaxForm({ success:function(data){
		//console.log(data);
