...
<div class="ccm-edit-mode-disabled-item" style="height:100px">
	<div style="padding: 30px 0px 0px 0px">
		<?php            echo t('Three Columns Page List <br />Content disabled in edit mode.')?>
    </div>
</div>
...
<div class="ccm-page-list-sortable ccm-page-list-column ccm-page-list-three-column">
	...
	<div class="isotope-container">
		<?php      foreach ($pages as $n => $page):
			...
			$thumb = is_object($img) ? $ih->getThumbnail($img, 351, 197, array('crop' => true, 'quality'=>$t->jpg_quality)) : null;
			$tags = $page->getAttribute('tags');
			$comment_count = $ch->comment_count($page);
			?>
			<div class="<?php      echo $category ?> element element-three-columns-sortable" <?php      if ($category) : ?>data-category="<?php      echo $category ?>" <?php      endif ?> style="">
				<div class="element-three-columns-sortable-inner">
					<div class="thumb">
