...
<div class="col_12 ccm-page-list-column ccm-page-list-four-column-static ccm-page-list-static">
<?php      foreach ($pages as $n => $page):
	...
	$thumb = is_object($img) ? $ih->getThumbnail($img, 250, 150, array('crop' => true, 'quality'=>$t->jpg_quality)) : null;
	...
	<?php       if ($last) echo '<div class="clear spacer"></div>'?>
