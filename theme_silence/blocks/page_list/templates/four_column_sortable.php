...
<div class="ccm-edit-mode-disabled-item" style="height:100px">
	<div style="padding: 30px 0px 0px 0px">
		<?php            echo t('four Columns Page List <br />Content disabled in edit mode.')?>
    </div>
</div>
...
print_r($t);
 ?>
  -->
<div class="ccm-page-list-sortable ccm-page-list-column ccm-page-list-four-column">
	...
	<div class="isotope-container">
		<?php      foreach ($pages as $n => $page):
			...
			?>
			<div class="<?php      echo $category ?> element element-four-columns-sortable" <?php      if ($category) : ?>data-category="<?php      echo $category ?>" <?php      endif ?> style="">
				<div class="element-four-columns-sortable-inner">
					<div class="thumb">
