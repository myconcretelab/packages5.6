...
class SupermintInstallerUtils {
	...
	public function getOrInstallCollectionAttributeSelect($akHandle, $akName, $values = array(),$asID = false, $allowMultipleValues = false, $allowOtherValues = false, $displayOrder = 'display_asc', $isSearchableInFrontEnd = false, $isSearchableInDashboardSitemap = false) {
	...
	public function getOrAddSinglePage($cPath, $cName = '', $cDescription = '', $icon = false) {
		...
		if ($icon)
			$this->_setupDashboardIcon($sp, $icon);
