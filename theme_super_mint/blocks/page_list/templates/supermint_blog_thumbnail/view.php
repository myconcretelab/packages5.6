<?php  
	...
	$ch = Loader::helper('comments', 'theme_super_mint');
	...
	<div class="span2 last blog_post">
	...
	<div class="span3">
		<a <?php   if ($target != '') { ?> target="<?php  echo $target?>" <?php   } ?> href="<?php  echo $nh->getLinkToCollection($cobj)?>"><h3 style="margin-top:0"><?php  echo $title?></h3></a>
