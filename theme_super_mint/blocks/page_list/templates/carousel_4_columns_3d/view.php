...
<div class="ccm-page-list bxslider ccm-page-list-3d ccm-page-list-3d-4-col" data-carousel="true" data-maxslides="<?php echo $max_columns_number ?>" data-minslides="<?php echo $min_columns_number ?>" data-slidewidth="<?php echo (1170 / $max_columns_number) ?>">
