...
$o = new ThemeSuperMintOptions($o);

$this->inc('elements/header.php');
?>
<div id="middle_unbordered" class="unbordered">
	<?php if($o->__display_top_box) : ?>
	<div id="top-page">
				...
				<div class="span12" id="page-top-unbordered">
					<div class="row">
						<div class="span3 title">
							<?php if($o->__display_page_title) : ?><h3 class="alternate left"><?php echo $c->getCollectionName() ?></h3><?php else : ?>&nbsp <?php endif ?>
						</div>
						<div class="span5 desc">
							<?php if($o->__display_page_desc) : ?><p class="tiny"><?php echo $c->getCollectionDescription() ?></p><?php else : ?>&nbsp <?php endif ?>
						</div>
						<?php if($o->__display_breadcrumb) : ?>
