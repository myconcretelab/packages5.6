...
<div class="icooon-box icooon-box_content">
	...
	<?php  if (isset($linkTo)) : ?> <a href="<?php  echo $linkTo ?>" class="button button-flat-primary"><?php  echo html_entity_decode($textLink) ?> <i class="fa fa-arrow-right"></i></a><?php  endif ?>
</div>
